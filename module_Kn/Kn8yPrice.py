...
#print(dfs[2][1][11])
    ...
    bt_roe1 = float(Context(prec=4, rounding=ROUND_HALF_UP).create_decimal(float(bt1)/float(sh1))) #稅前ROE
    
    #bt_roe1 = round(float(bt1)/float(sh1),4) 
    bt_roe2 = float(Context(prec=4, rounding=ROUND_HALF_UP).create_decimal(float(bt2)/float(sh2)))
    bt_roe3 = float(Context(prec=4, rounding=ROUND_HALF_UP).create_decimal(float(bt3)/float(sh3)))
    bt_roe4 = float(Context(prec=4, rounding=ROUND_HALF_UP).create_decimal(float(bt4)/float(sh4)))

    bt_roe5 = float(Context(prec=4, rounding=ROUND_HALF_UP).create_decimal(float(bt5)/float(sh5)))
    bt_roe6 = float(Context(prec=4, rounding=ROUND_HALF_UP).create_decimal(float(bt6)/float(sh6)))
    bt_roe7 = float(Context(prec=4, rounding=ROUND_HALF_UP).create_decimal(float(bt7)/float(sh7)))
    bt_roe8 = float(Context(prec=4, rounding=ROUND_HALF_UP).create_decimal(float(bt8)/float(sh8)))

    bt_roe1_8ave = round((bt_roe1 + bt_roe2 + bt_roe3 + bt_roe4 + bt_roe5 + bt_roe6 + bt_roe7 + bt_roe8)/8,4)
  
    print(bt_roe1)
    
    #ROE 去除後面太多小數位數的處理
    if len(str(bt_roe1)) > 3:   #原本>5
        bt_roe1p = (str(bt_roe1*100))[:4]+ "%"
    else:
        bt_roe1p = str(bt_roe1*100)+ "%"
        
    if len(str(bt_roe2)) > 3:
        bt_roe2p = (str(bt_roe2*100))[:4]+ "%"
    else:
        bt_roe2p = str(bt_roe2*100)+ "%"
    
    if len(str(bt_roe3)) > 3:
        bt_roe3p = (str(bt_roe3*100))[:4]+ "%"
    else:
        bt_roe3p = str(bt_roe3*100)+ "%"

    if len(str(bt_roe4)) > 3:
        bt_roe4p = (str(bt_roe4*100))[:4]+ "%"
    else:
        bt_roe4p = str(bt_roe4*100)+ "%"


    if len(str(bt_roe5)) > 3:
        bt_roe5p = (str(bt_roe5*100))[:4]+ "%"
    else:
        bt_roe5p = str(bt_roe5*100)+ "%"
        
    if len(str(bt_roe6)) > 3:
        bt_roe6p = (str(bt_roe6*100))[:4]+ "%"
    else:
        bt_roe6p = str(bt_roe6*100)+ "%"
        
    if len(str(bt_roe7)) > 3:
        bt_roe7p = (str(bt_roe7*100))[:4]+ "%"
    else:
        bt_roe7p = str(bt_roe7*100)+ "%"
        
    if len(str(bt_roe8)) > 3:
        bt_roe8p = (str(bt_roe8*100))[:4]+ "%"
    else:
        bt_roe8p = str(bt_roe8*100)+ "%" 
        
    if len(str(bt_roe1_8ave)) > 3:
        bt_roe1_8avep = (str(bt_roe1_8ave*100))[:4]+ "%"
    else:
        bt_roe1_8avep = str(bt_roe1_8ave*100)+ "%"        
...
################################################
    ...
    pb1_H = round(float(H1)/float(b1),2)
    pb1_L = round(float(L1)/float(b1),2)    
    
    try:
        pb2_H = round(float(H2)/float(b2),2)
        pb2_L = round(float(L2)/float(b2),2)  
    except:
        pb2_H = 0
        pb2_L = 0         
    ...
    try:
        pb3_H = round(float(H3)/float(b3),2)
        pb3_L = round(float(L3)/float(b3),2)
    except:
        pb3_H = 0
        pb3_L = 0       
    
    try:
        pb4_H = round(float(H4)/float(b4),2)
        pb4_L = round(float(L4)/float(b4),2)  
    except:
        pb4_H = 0
        pb4_L = 0 
        
    try:
        pb5_H = round(float(H5)/float(b5),2)
        pb5_L = round(float(L5)/float(b5),2)    
    except:
        pb5_H = 0
        pb5_L = 0        
        
    try:
        pb6_H = round(float(H6)/float(b6),2)
        pb6_L = round(float(L6)/float(b6),2)
    except:
        pb6_H = 0
        pb6_L = 0        
    
    try:
        pb7_H = round(float(H7)/float(b7),2)
        pb7_L = round(float(L7)/float(b7),2)  
    except:
        pb7_H = 0
        pb7_L = 0          
        
    try:    
        pb8_H = round(float(H8)/float(b8),2)
        pb8_L = round(float(L8)/float(b8),2) 
    except:
        pb8_H = 0
        pb8_L = 0 
        
    pb1_8_Have0 = (pb1_H + pb2_H + pb3_H + pb4_H + pb5_H + pb6_H + pb7_H + pb8_H)/8
        
    if len(str(pb1_8_Have0)) > 3:
        pb1_8_Have = (str(pb1_8_Have0))[:4]
    else:
        pb1_8_Have = str(pb1_8_Have0) 


    pb1_8_Lave0 = (pb1_L + pb2_L + pb3_L + pb4_L + pb5_L + pb6_L + pb7_L + pb8_L)/8        

    if len(str(pb1_8_Lave0)) > 3:
        pb1_8_Lave = (str(pb1_8_Lave0))[:4]
    else:
        pb1_8_Lave = str(pb1_8_Lave0)
        
    print(pb1_H)


    #Context(prec=3, rounding=ROUND_HALF_UP).create_decimal('1.32499999')
    kn1_H = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe1/pb1_H))
    kn1_L = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe1/pb1_L))
   
    
    try:
        kn2_H = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe2/pb2_H))
        kn2_L = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe2/pb2_L))
    except:
        kn2_H = 0
        kn2_L = 0         
    
    try:
        kn3_H = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe3/pb3_H))
        kn3_L = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe3/pb3_L))
    except:
        kn3_H = 0
        kn3_L = 0        
    
    try:
        kn4_H = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe4/pb4_H))
        kn4_L = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe4/pb4_L))
    except:
        kn4_H = 0
        kn4_L = 0     

    try:
        kn5_H = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe5/pb5_H))
        kn5_L = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe5/pb5_L))
    except:
        kn5_H = 0
        kn5_L = 0

    try:    
        kn6_H = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe6/pb6_H))
        kn6_L = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe6/pb6_L))
    except:
        kn6_H = 0
        kn6_L = 0
        
    try:
        kn7_H = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe7/pb7_H))
        kn7_L = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe7/pb7_L))
    except:
        kn7_H = 0
        kn7_L = 0
        
    try:
        kn8_H = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe8/pb8_H))
        kn8_L = float(Context(prec=2, rounding=ROUND_HALF_UP).create_decimal(bt_roe8/pb8_L))
    except:
        kn8_H = 0
        kn8_L = 0        


    kn1_8_Have = round((kn1_H + kn2_H + kn3_H + kn4_H + kn5_H + kn6_H + kn7_H + kn8_H)/8,3)
    kn1_8_Lave = round((kn1_L + kn2_L + kn3_L + kn4_L + kn5_L + kn6_L + kn7_L + kn8_L)/8,3)
    ...
    #縮減小數位數
    if len(str(kn1_H)) > 3:
        kn1_Hp = (str(kn1_H*100))[:4]+ "%"
    else:
        kn1_Hp = str(kn1_H*100)+ "%"    
    if len(str(kn1_L)) > 3:
        kn1_Lp = (str(kn1_L*100))[:4]+ "%"
    else:
        kn1_Lp = str(kn1_L*100)+ "%"     
    
    if len(str(kn2_H)) > 3:
        kn2_Hp = (str(kn2_H*100))[:4]+ "%"
    else:
        kn2_Hp = str(kn2_H*100)+ "%"    
    if len(str(kn2_L)) > 3:
        kn2_Lp = (str(kn2_L*100))[:4]+ "%"
    else:
        kn2_Lp = str(kn2_L*100)+ "%" 

    if len(str(kn3_H)) > 3:
        kn3_Hp = (str(kn3_H*100))[:4]+ "%"
    else:
        kn3_Hp = str(kn3_H*100)+ "%"    
    if len(str(kn3_L)) > 3:
        kn3_Lp = (str(kn3_L*100))[:4]+ "%"
    else:
        kn3_Lp = str(kn3_L*100)+ "%" 

    if len(str(kn4_H)) > 3:
        kn4_Hp = (str(kn4_H*100))[:4]+ "%"
    else:
        kn4_Hp = str(kn4_H*100)+ "%"    
    if len(str(kn4_L)) > 3:
        kn4_Lp = (str(kn4_L*100))[:4]+ "%"
    else:
        kn4_Lp = str(kn4_L*100)+ "%" 

    if len(str(kn5_H)) > 3:
        kn5_Hp = (str(kn5_H*100))[:4]+ "%"
    else:
        kn5_Hp = str(kn5_H*100)+ "%"    
    if len(str(kn5_L)) > 3:
        kn5_Lp = (str(kn5_L*100))[:4]+ "%"
    else:
        kn5_Lp = str(kn5_L*100)+ "%" 

    if len(str(kn6_H)) > 3:
        kn6_Hp = (str(kn6_H*100))[:4]+ "%"
    else:
        kn6_Hp = str(kn6_H*100)+ "%"    
    if len(str(kn6_L)) > 3:
        kn6_Lp = (str(kn6_L*100))[:4]+ "%"
    else:
        kn6_Lp = str(kn6_L*100)+ "%" 

    if len(str(kn7_H)) > 3:
        kn7_Hp = (str(kn7_H*100))[:4]+ "%"
    else:
        kn7_Hp = str(kn7_H*100)+ "%"    
    if len(str(kn7_L)) > 3:
        kn7_Lp = (str(kn7_L*100))[:4]+ "%"
    else:
        kn7_Lp = str(kn7_L*100)+ "%"     

    if len(str(kn8_H)) > 3:
        kn8_Hp = (str(kn8_H*100))[:4]+ "%"
    else:
        kn8_Hp = str(kn8_H*100)+ "%"    
    if len(str(kn8_L)) > 3:
        kn8_Lp = (str(kn8_L*100))[:4]+ "%"
    else:
    ...
    if len(str(kn1_8_Have)) > 4:
        kn1_8_Havep = (str(kn1_8_Have*100))[:4]+ "%"
    else:
        kn1_8_Havep = str(kn1_8_Have*100)+ "%"    
    if len(str(kn1_8_Lave)) > 4:
        kn1_8_Lavep = (str(kn1_8_Lave*100))[:4]+ "%"
    else:
        kn1_8_Lavep = str(kn1_8_Lave*100)+ "%" 
