...
def getTseYearPrice(stock_id):
    ...
    return H1, L1, H2, L2, H3, L3, H4, L4, H5, L5, H6, L6
    
def getTseHighLowestPrice(stock_id):
...
#############################################################    
        ...
        #print(thisYearMax)
        thisYearMax = max(priceGroup)
        H0 = str(thisYearMax)  #111/2022年目前已出現過的最高價

        thisYearMin = min(priceGroup2)
        L0 = str(thisYearMin)  #111/2022年目前已出現過的最低價
...
#dfs[2][1] 由左至右 第一欄 最新季
    ...
    return eps1N, eps1, eps2, eps3, eps4, eps5, eps6
