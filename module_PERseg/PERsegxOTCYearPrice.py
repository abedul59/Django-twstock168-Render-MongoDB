...
def getOtcYearPriceEPS(stock_id):
...
###########################################
        ...
        if (tablelen >= 7): #原本 >=9 #有6年以上歷史資料  含當年度有6年
    #ls0 = lastyear1 = dfs[0].iloc[2] #當年 2022/111年
            ls0 =  dfs[0].iloc[0] #原本[2]#當年2023/112年  2021/11/17整個編號有問題iloc
        ...
        #L0 = ls0[6] #109年目前已出現過的最低價
            ...
            H1 = ls1[5] #2023/112年最高價  原本[4]
            L1 = ls1[7] #        年最低價 原本[6]
            print(H1,L1)


            H2 = ls2[5] #2022/111年最高價
            L2 = ls2[7] #        年最低價

            H3 = ls3[5] #2021/110年最高價
            L3 = ls3[7] #   年最低價

            H4 = ls4[5] #2020/109年最高價
            L4 = ls4[7] #   年最低價
...
#dfs[2] 真
        ...
        elif (tablelen == 6):  #原本 ==8  #去掉當年，只有過去5年資料  2022/2/18新增 2022/1/4 修改
...
#dfs[2][1][98] #最新1年的合併總損益 每股盈餘
    ...
    ####2020/07/02 加入本益比成長率
        ...
        return H0, H1, L1, H2, L2, H3, L3, H4, L4, H5, L5, H6, L6, eps1, eps2, eps3, eps4, eps5, PER_H1, PER_L1, PER_H2, PER_L2, PER_H3, PER_L3, PER_H4, PER_L4, PER_H5, PER_L5, PER_L5, PER_H_average, PER_L_average, PER_H, PER_L, eps1N


#####################################################################################################
    H0, H1, L1, H2, L2, H3, L3, H4, L4, H5, L5, H6, L6, eps1, eps2, eps3, eps4, eps5, PER_H1, PER_L1, PER_H2, PER_L2, PER_H3, PER_L3, PER_H4, PER_L4, PER_H5, PER_L5, PER_L5, PER_H_average, PER_L_average, PER_H, PER_L, eps1N = main(stock_id)
