...
def PERsegPEGxDB(stock_id, month_id):
    ...
    seg = models.PriEPSPER_DB.objects.get(cStockID=stock_id)
    ...
    PER_H1 = seg.cPER_H2020 
    PER_H2 = seg.cPER_H2019
    PER_H3 = seg.cPER_H2018
    PER_H4 = seg.cPER_H2017
    PER_H5 = seg.cPER_H2016
    
    
    PER_L1 = seg.cPER_L2020
    PER_L2 = seg.cPER_L2019
    PER_L3 = seg.cPER_L2018
    PER_L4 = seg.cPER_L2017
    PER_L5 = seg.cPER_L2016
#dfs[2] 真正表格
...
##################################取得稅後淨利率##################################
    ...
    seg2 = models.NetCap_DB.objects.get(cStockID=stock_id)
...
#dfs[2][1][13] 最新一季稅後淨利率
    ...
    Net1 = seg2.cNet21Q2 #最新1季的稅後淨利率
    Net2 = seg2.cNet21Q1 #最新1季的稅後淨利率
    Net3 = seg2.cNet20Q4 #最新1季的稅後淨利率
    Net4 = seg2.cNet20Q3 #最新1季的稅後淨利率
...
####################################################取得股本
    ...
    cap1 = seg2.cCap21Q2 #最新一季股本（單位：百萬） 2020/7/4 要轉換成 億
#print(table)
...
####################計算預估EPS 2021/2/2修改
    ...
    if epsq1N == '2020.4Q' :  #5/15前公佈2021Q1財報
...
#####################
    ...
    elif epsq1N == '2021.1Q' :   #2021/5/29增加
