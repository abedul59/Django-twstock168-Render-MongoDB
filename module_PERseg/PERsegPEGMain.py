...
from module_PERseg import PERsegxTSEYearPrice
from module_PERseg import PERsegxOTCYearPricePEG
from module_PERseg import PERsegxGetQuarterEPS
from module_PERseg import PERsegxGetRev
from module_PERseg import PERsegxGetNet
from module_PERseg import PERsegxGetCap
from module_PERseg import PERsegxGetPrice
def PERsegPEGMain(stock_id, month_id):
...
######################################################################
    if stock_id in TSEAll:  #查詢上市年股價
        ...
        H1, L1, H2, L2, H3, L3, H4, L4, H5, L5, H6, L6  = PERsegxTSEYearPrice.getTseYearPrice(stock_id) #取得上市年價格

#
        H0, L0 = PERsegxTSEYearPrice.getTseHighLowestPrice(stock_id) #取得上市當年最高價


        eps1N, eps1, eps2, eps3, eps4, eps5, eps6 = PERsegxTSEYearPrice.getTseYearEPS(stock_id) #取得過去五年 年EPS
...
################################################接著取得股票EPS
        H0, H1, L1, H2, L2, H3, L3, H4, L4, H5, L5, H6, L6, eps1, eps2, eps3, eps4, eps5, PER_H1, PER_L1, PER_H2, PER_L2, PER_H3, PER_L3, PER_H4, PER_L4, PER_H5, PER_L5, PER_L5, PER_H_average, PER_L_average, PER_H, PER_L, eps1N, PER_H_YoY1, PER_H_YoY2, PER_H_YoY3, PER_H_YoY4, PEG_H1, PEG_H2, PEG_H3, PEG_H4, PEG_L1, PEG_L2, PEG_L3, PEG_L4, epsYoY1, epsYoY2, epsYoY3, epsYoY4 = PERsegxOTCYearPricePEG.getOtcYearPriceEPSPEG(stock_id)
...
####################計算預估EPS 2021/2/2修改
    ...
    if epsq1N == '2021.4Q' :  #5/15前公佈2022Q1財報 2022/1/1才啟用
...
#####################
    ...
    elif epsq1N == '2022.1Q' :   #2021/5/29 2021/10/09增加
...
#########################################
    ...
    elif epsq1N == '2021.2Q' :   #2021/10/9增加
...
######################2021年的本益比為估算，因為2021年尚未結束###################
    ...
    elif epsq1N == '2021.3Q' :   #2021/10/9增加 2022/1/1後 2022 4月2021Q4財報公佈前
