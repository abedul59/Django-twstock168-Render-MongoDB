...
#收集資料創建時間
    ...
    dayOnly = wholetime[8:10]
    print(dayOnly)
    monthOnly = wholetime[5:7]
    print(monthOnly)
    '''

    #改變資料庫 取得現在時間資料庫的類別 也存在於views_monthAlterStuff.py
def DBfunc():
    ...
    class NowTimeDBs:  
        ...
        def __init__(self): 
        #資料庫串列 共13個
            self.DBsLists = [Stock6Sign202112, Stock6Sign202201, Stock6Sign202202, Stock6Sign202203, Stock6Sign202204, Stock6Sign202205, Stock6Sign202206, Stock6Sign202207, Stock6Sign202208, Stock6Sign202209, Stock6Sign202210, Stock6Sign202211, Stock6Sign202212]
            self.PERDBsLists = [StockPERseg202112, StockPERseg202201, StockPERseg202202, StockPERseg202203, StockPERseg202204, StockPERseg202205, StockPERseg202206, StockPERseg202207, StockPERseg202208, StockPERseg202209, StockPERseg202210, StockPERseg202211, StockPERseg202212]
        ...
        #每月需要的資料庫變數
            if int(self.monthOnly) == 5 and int(self.dayOnly) < 19:
                ...
                self.EPSAy = self.EPSaDBsLists[0]
                self.EPSAz = self.EPSaDBsLists[1]                 
            elif int(self.monthOnly) == 8 and int(self.dayOnly) < 19:
            ...
            elif int(self.monthOnly) == 11 and int(self.dayOnly) < 19:
            ...
            elif int(self.monthOnly) == 1 or 2 or 3:
    
                self.EPSAy = self.EPSaDBsLists[2]
                self.EPSAz = self.EPSaDBsLists[3]

            elif int(self.monthOnly) == 4 and int(self.dayOnly) < 5:
    
                self.EPSAy = self.EPSaDBsLists[2]
                self.EPSAz = self.EPSaDBsLists[3]

            elif int(self.monthOnly) == 4 and int(self.dayOnly) >= 6:
    
                self.EPSAy = self.EPSaDBsLists[3]
                self.EPSAz = self.EPSaDBsLists[4]                
        ...
        #每月需要的資料庫變數
            ...
            elif int(self.monthOnly) == 5 and int(self.dayOnly) < 18:
            ...
            elif int(self.monthOnly) == 6 or 7:
    
                self.EPSNy = self.EPSnDBsLists[0]
                self.EPSNz = self.EPSnDBsLists[1]                
                
            elif int(self.monthOnly) == 8 and int(self.dayOnly) < 18:
            ...
            elif int(self.monthOnly) == 9 or 10:
    
                self.EPSNy = self.EPSnDBsLists[1]
                self.EPSNz = self.EPSnDBsLists[2]

            elif int(self.monthOnly) == 11 and int(self.dayOnly) < 18:
            ...
            elif int(self.monthOnly) == 12 or 1 or 2 or 3:
    
                self.EPSNy = self.EPSnDBsLists[2]
                self.EPSNz = self.EPSnDBsLists[3] 
                
            elif int(self.monthOnly) == 4 and int(self.dayOnly) < 3:
        ...
        #每月需要的資料庫變數
            ...
            eif int(self.monthOnly) == 4 and int(self.dayOnly) < 3:
