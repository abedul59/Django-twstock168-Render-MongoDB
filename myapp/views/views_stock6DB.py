...
def stock6xDB(request):  #查詢六大指標，給付費使用者使用
    ...
    if request.method == "POST":  #假如是以POST方式才處理
        ...
        if a1N[-2:] == '04':
            ...
            try:
                signA = models.Stock6Sign202203.objects.get(cStockID=mess)
                lastmonthAve = signA.cAverageScore  
            
                signB = models.Stock6Sign202202.objects.get(cStockID=mess)
                lastx2monthAve = signB.cAverageScore  

                signC = models.Stock6Sign202201.objects.get(cStockID=mess)
            ...
            try:
                signA = models.Stock6Sign202212.objects.get(cStockID=mess)
                lastmonthAve = signA.cAverageScore  
            
                signB = models.Stock6Sign202211.objects.get(cStockID=mess)
                lastx2monthAve = signB.cAverageScore  

                signC = models.Stock6Sign202210.objects.get(cStockID=mess)
                lastx3monthAve = signC.cAverageScore 
            except:
                lastmonthAve = "N/A"
                lastx2monthAve = "N/A"
            ...
            try:
                signA = models.Stock6Sign202211.objects.get(cStockID=mess)
                lastmonthAve = signA.cAverageScore  
            
                signB = models.Stock6Sign202210.objects.get(cStockID=mess)
                lastx2monthAve = signB.cAverageScore  

                signC = models.Stock6Sign202209.objects.get(cStockID=mess)
                lastx3monthAve = signC.cAverageScore 
            except:
                lastmonthAve = "N/A"
                lastx2monthAve = "N/A"
            ...
            try:
                signA = models.Stock6Sign202210.objects.get(cStockID=mess)
                lastmonthAve = signA.cAverageScore  
            
                signB = models.Stock6Sign202209.objects.get(cStockID=mess)
                lastx2monthAve = signB.cAverageScore  

                signC = models.Stock6Sign202208.objects.get(cStockID=mess)
                lastx3monthAve = signC.cAverageScore 
            except:
                lastmonthAve = "N/A"
                lastx2monthAve = "N/A"
            ...
            try:
                signA = models.Stock6Sign202207.objects.get(cStockID=mess)
                lastmonthAve = signA.cAverageScore  
            
                signB = models.Stock6Sign202206.objects.get(cStockID=mess)
                lastx2monthAve = signB.cAverageScore  

                signC = models.Stock6Sign202205.objects.get(cStockID=mess)
                lastx3monthAve = signC.cAverageScore 
            except:
                lastmonthAve = "N/A"
                lastx2monthAve = "N/A"
            ...
            try:
                signA = models.Stock6Sign202206.objects.get(cStockID=mess)
                lastmonthAve = signA.cAverageScore  
            
                signB = models.Stock6Sign202205.objects.get(cStockID=mess)
                lastx2monthAve = signB.cAverageScore  

                signC = models.Stock6Sign202204.objects.get(cStockID=mess)
                lastx3monthAve = signC.cAverageScore 
            except:
                lastmonthAve = "N/A"
                lastx2monthAve = "N/A"
            ...
            try:
                signA = models.Stock6Sign202205.objects.get(cStockID=mess)
                lastmonthAve = signA.cAverageScore  
            
                signB = models.Stock6Sign202204.objects.get(cStockID=mess)
                lastx2monthAve = signB.cAverageScore  

                signC = models.Stock6Sign202203.objects.get(cStockID=mess)
                lastx3monthAve = signC.cAverageScore 
            except:
                lastmonthAve = "N/A"
                lastx2monthAve = "N/A"
            ...
            try:
                signA = models.Stock6Sign202204.objects.get(cStockID=mess)
                lastmonthAve = signA.cAverageScore  
            
                signB = models.Stock6Sign202203.objects.get(cStockID=mess)
                lastx2monthAve = signB.cAverageScore  

                signC = models.Stock6Sign202202.objects.get(cStockID=mess)
                lastx3monthAve = signC.cAverageScore 
            except:
                lastmonthAve = "N/A"
                lastx2monthAve = "N/A"
