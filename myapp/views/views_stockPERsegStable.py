...
from module_PERseg import PERseg3
    ...
    if request.method == "POST":  #假如是以POST方式才處理
        ...
        if (-0.3 < P_Hw1 < 0.3 and -0.3 < P_Hw2 < 0.3 and -0.3 < P_Hw3 < 0.3 and -0.3 < P_Hw4 < 0.3 and -0.3 < P_Hw5 < 0.3) and (-0.3 < P_Lw1 < 0.3 and -0.3 < P_Lw2 < 0.3 and -0.3 < P_Lw3 < 0.3 and -0.3 < P_Lw4 < 0.3 and -0.3 < P_Lw5 < 0.3):
            try:  #先試著看料庫有沒有這個股票，若沒有 跳到except處理
                sta = StockPERsegStable2023Q3.objects.get(cStockID=mess)
                ...
                sta = StockPERsegStable2023Q3.objects.create(cStockID=mess, cStockName=stock_name, cPER_H1=PER_H1, cPER_L1=PER_L1, cPER_H2=PER_H2, cPER_L2=PER_L2, cPER_H3=PER_H3, cPER_L3=PER_L3, cPER_H4=PER_H4, cPER_L4=PER_L4, cPER_H5=PER_H5, cPER_L5=PER_L5, cPER_H_average=PER_H_average, cPER_L_average=PER_L_average, pubtime=realtime)
