...
#dfs[2][1][98] #最新1年的合併總損益 每股盈餘
            if eps1N == '2020':  #在三月時，Q4財報先出來的情況
                ...
                eps1 = dfs0[2][1][98] #最新1年的合併總損益 每股盈餘 2020
                eps2 = dfs0[2][2][98] #最新2年的合併總損益 每股盈餘 2019
                eps3 = dfs0[2][3][98] #最新3年的合併總損益 每股盈餘 2018
                eps4 = dfs0[2][4][98] #最新4年的合併總損益 每股盈餘 2017/106
    ...
    ####2020/07/02 加入本益比成長率
                ...
                eps1 = dfs0[2][1][98] #最新1年的合併總損益 每股盈餘 2019
                eps2 = dfs0[2][2][98] #最新2年的合併總損益 每股盈餘 2018
                eps3 = dfs0[2][3][98] #最新3年的合併總損益 每股盈餘 2017
                eps4 = dfs0[2][4][98] #最新4年的合併總損益 每股盈餘 2016/105
                eps5 = None #最新5年的合併總損益 每股盈餘 2015/104
...
#dfs[2] 真
            if eps1N == '2020':  #在三月時，Q4財報先出來的情況
                ...
                eps2 = dfs0[2][2][98] #最新2年的合併總損益 每股盈餘 2019
                eps3 = dfs0[2][3][98] #最新3年的合併總損益 每股盈餘 2018
                eps4 = dfs0[2][4][98] #最新4年的合併總損益 每股盈餘 2017
                eps5 = dfs0[2][5][98] #最新5年的合併總損益 每股盈餘 2016
                ...
                eps3 = dfs0[2][3][98] #最新3年的合併總損益 每股盈餘 2017
                eps4 = dfs0[2][4][98] #最新4年的合併總損益 每股盈餘 2017
                eps5 = dfs0[2][5][98] #最新5年的合併總損益 每股盈餘 2015
