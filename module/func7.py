...
#dfs[2][1] 由左至右 第一欄 最新季
        ...
        if eps1N == '2021':  #在3/31前，Q4財報先出來的情況  年度轉換時還不適用
...
#print(PER_H1)
        ...
        elif eps1N == '2020':  #3/31前，Q4財報還沒出來的情況 沒有2021的全年EPS
    ####2020/07/02 加入本益比成長率
