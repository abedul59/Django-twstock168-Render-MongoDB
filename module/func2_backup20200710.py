...
#print(a1)
    ...
    #print(a9)
    a10 = round(float((a1-a2)/a2),3) #最新一季月增率
    #print(a10)
    a11 = float((a2-a3)/a3) #次新一季月增率
    #print(a11)
    a12 = float((a3-a4)/a4) #第3新一季月增率
    #print(a12)
    a13 = float((a4-a5)/a5) #第4新一季月增率
    #print(a13)
    ...
    elif (0.15 >= a9 >= 0.1) and (a10 >= -0.2) and (a11 >= -0.2) and (a12 >= -0.2): 
        result1 = "A"      #過去四季皆維持穩定沒有下降，且平均在10-15%

        
    elif (0.1 > a9 >= 0.05) and (a10 > 0) and (a11 >= -0.2) and (a12 >= -0.2):
        result1 = "A"      #或過去四季皆維持穩定沒有下跌，平均只有5-10%，但最近一季呈現上升趨勢

    elif (a9 >= 0.15) and (a10 >= -0.2) and (a11 >= -0.2) and (a12 >= -0.2):
        result1 = "AA"   #過去四季皆維持穩定沒有下降，且平均在15%以上
        
    elif (0.15 >= a9 >= 0.1) and (a10 > 0) and (a11 >= -0.2) and (a12 >= -0.2):
    ...
    return result1, ProfitN, Profit, a1N, a2N, a3N, a4N, a5N, a6N, a7N, a8N, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10
...
#dfs[2][4][6] 最新一個月年增率
    ...
    elif (b9 > 0.25 and 0.5 > b10 >= 0):
        result2 = "AA"
                        
    elif (b9 > 0.25 and 0 > b10 >= -0.5):
        result2 = "A"      #或過去六個月平均超過25%，但最近一個月出現小幅衰退。（年增率較上個月下跌幅度在50%以內）   

    elif (b1 > 0 and b2 > 0 and b3 > 0 and b4 > 0 and b5 >0 and b6 > 0 and 0.25 >= b9 >= 0.1 and b10 >= 0):
    ...
    return result2, RevN, Rev, b1N, b2N, b3N, b4N, b5N, b6N, nb1, nb2, nb3, nb4, nb5, nb6
    #print (result1)
##############################################################
################################################################
...
#print(a1)
    c9 = float((c1-c5)/c5) #最新一季淨利年增率
#print(c9)
    c10 = float((c2-c6)/c6) #次新一季淨利年增率
#print(c10)
    c11 = float((c3-c7)/c7) #第3新一季淨利年增率
    #print(c11)
    c12 = float((c4-c8)/c8) #第4新一季淨利年增率
