...
#zzz = lastyear1[6] #最高價
    ...
    ls1 = lastyear1 = dfs[0].iloc[-1] #108年
    ls2 = lastyear2 = dfs[0].iloc[-2] #107年
    ls3 = lastyear3 = dfs[0].iloc[-3] #106年
    ls4 = lastyear4 = dfs[0].iloc[-4] #105年
    ls5 = lastyear5 = dfs[0].iloc[-5] #104年
...
#目前2020/5/12
    rYoY1 = latest_month_Rev = round(float(dfs[2][4][6][:-1])/100,4) #最新一個月年增率
    ...
    rYoY6Average = lastest_6month_RevAverage = (rYoY1+rYoY2+rYoY3+rYoY4+rYoY5+rYoY6)/6 #最新六個月營收平均
#print(rYoY6Average)
