# -*- coding: utf-8 -*-
"""
Created on Mon Oct 12 15:35:40 2020
...
#################以下為本益比區間程式 自行調整參數
def PERseg3(stock_id, month_id, revyoy_id):
...
#print(rYoY6Average)
    ...
    RevYoY = float(revyoy_id) #改成輸入營收年增率參數 小數
...
#dfs[2][1][13] 最新一季稅後淨利率
    ...
    #Net4Average = netaverage4_id  #改成輸入稅後淨利率平均 參數 小數
...
#low  = dfs[2][5][1] #最低價
#close  = dfs[2][7][1] #收盤價
    #capital_stock = float(stockcapital_id) #本來Basic表股本 單位：億 改成輸入股本 參數
