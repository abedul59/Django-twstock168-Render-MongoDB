...
def stock_Prof2_InvTO5(stock_id):  #營業利益率評分標準
...
#print(dfs[2][1][10])
    ...
    b1 = float((dfs[2][1][10])) #最新1季的營益率
    b2 = float((dfs[2][2][10])) #最新2季的營益率 
    b3 = float((dfs[2][3][10])) #最新3季的營益率
    b4 = float((dfs[2][4][10])) #最新4季的營益率
    b5 = float((dfs[2][5][10])) #最新5季的營益率
    b6 = float((dfs[2][6][10])) #最新6季的營益率
    b7 = float((dfs[2][7][10])) #最新7季的營益率
    b8 = float((dfs[2][8][10])) #最新8季的營益率
